...
c1.images.attach(io:c1_2, filename: 'chair/neva/neva3.jpeg')
c1.images.attach(io:c1_3, filename: 'chair/neva/neva4.jpeg')
c1.images.attach(io:c1_4, filename: 'chair/neva/neva5.webp')
c1.images.attach(io:c1_5, filename: 'chair/neva/neva6.jpeg')
c1.images.attach(io:c1_6, filename: 'chair/neva/neva7.png')
c1.images.attach(io:c1_7, filename: 'chair/neva/neva8.webp')
...
c2.images.attach(io:c2_2, filename: 'chair/aria/aria3.webp')
c2.images.attach(io:c2_3, filename: 'chair/aria/aria4.webp')
c2.images.attach(io:c2_4, filename: 'chair/aria/aria5.webp')
c2.images.attach(io:c2_5, filename: 'chair/aria/aria6.webp')
c2.images.attach(io:c2_6, filename: 'chair/aria/aria7.webp')
c2.images.attach(io:c2_7, filename: 'chair/aria/aria8.webp')
c2.images.attach(io:c2_8, filename: 'chair/aria/aria9.jpeg')
...
c3.images.attach(io:c3_1, filename: 'chair/gabe/gabe2.jpeg')
c3.images.attach(io:c3_2, filename: 'chair/gabe/gabe3.jpeg')
c3.images.attach(io:c3_3, filename: 'chair/gabe/gabe4.jpeg')
c3.images.attach(io:c3_4, filename: 'chair/gabe/gabe5.webp')
c3.images.attach(io:c3_5, filename: 'chair/gabe/gabe6.webp')
...
c4.images.attach(io:c4_1, filename: 'chair/elias/elias2.webp')
c4.images.attach(io:c4_2, filename: 'chair/elias/elias3.webp')
c4.images.attach(io:c4_3, filename: 'chair/elias/elias4.jpeg')
c4.images.attach(io:c4_4, filename: 'chair/elias/elias5.jpeg')
c4.images.attach(io:c4_5, filename: 'chair/elias/elias6.jpeg')
...
c5.images.attach(io:c5_2, filename: 'chair/amelia/amelia3.webp')
...
c6.images.attach(io:c6_1, filename: 'chair/qunicy/qunicy2.webp')
c6.images.attach(io:c6_2, filename: 'chair/qunicy/qunicy3.jpeg')
c6.images.attach(io:c6_3, filename: 'chair/qunicy/qunicy4.webp')
